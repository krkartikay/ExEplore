Delta = function () {
  ...
  var cfg = {
    ...
    images: [
      { id: "sprites", url: "/static/dm/images/sprites.png" },
      { id: "aliens", url: "/static/dm/images/aliens.png" },
      { id: "rocks", url: "/static/dm/images/rocks.png" },
      { id: "bullets", url: "/static/dm/images/bullets.png" }
    ],

    sounds: [
      { id: "title", name: "/static/dm/sounds/title", formats: ['mp3', 'ogg'], volume: 0.4, loop: true },
      { id: "game", name: "/static/dm/sounds/game", formats: ['mp3', 'ogg'], volume: 0.8, loop: true },
      { id: "shoot", name: "/static/dm/sounds/shoot", formats: ['mp3', 'ogg'], volume: 0.04, pool: 5 },
      { id: "explode", name: "/static/dm/sounds/explode", formats: ['mp3', 'ogg'], volume: 0.10, pool: 5 }
    ],
    ...
    sprites: {
      ...
      player: {
        fps: 30, frames: [{ x: 101, y: 1, w: 32, h: 16 }, { x: 101, y: 1, w: 32, h: 16 }, { x: 101, y: 1, w: 32, h: 16 }, { x: 101, y: 1, w: 32, h: 16 }, { x: 101, y: 1, w: 32, h: 16 }, { x: 101, y: 1, w: 32, h: 16 }, { x: 101, y: 1, w: 32, h: 16 },
      ...
      thrust: {
        fps: 20, frames: [{ x: 134, y: 18, w: 32, h: 32 },
      ...
      alien1: {
        fps: 20, frames: [{ x: (0 * 17) + 1, y: 1, w: 16, h: 16 },
      ...
      alien2: {
        fps: 20, frames: [{ x: (0 * 34) + 1, y: 32 + 1, w: 32, h: 32 },
      ...
      alien3: {
        fps: 20, frames: [{ x: (0 * 34) + 1, y: 64 + 1, w: 32, h: 32 },
